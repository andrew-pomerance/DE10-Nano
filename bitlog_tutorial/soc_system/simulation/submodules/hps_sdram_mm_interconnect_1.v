...
`timescale 1 ps / 1 ps
module hps_sdram_mm_interconnect_1 (
		...
		output wire [15:0] avl2apb_avalon_slave_address,                 //                   avl2apb_avalon_slave.address
		output wire        avl2apb_avalon_slave_write,                   //                                       .write
		output wire        avl2apb_avalon_slave_read,                    //                                       .read
		input  wire [31:0] avl2apb_avalon_slave_readdata,                //                                       .readdata
		output wire [31:0] avl2apb_avalon_slave_writedata,               //                                       .writedata
		output wire [3:0]  avl2apb_avalon_slave_byteenable,              //                                       .byteenable
		input  wire        avl2apb_avalon_slave_waitrequest,             //                                       .waitrequest
	...
	wire  [91:0] rsp_mux_src_data;                                                               // rsp_mux:src_data -> cpu_inst_data_master_agent:rp_data
	wire         rsp_mux_src_ready;                                                              // cpu_inst_data_master_agent:rp_ready -> rsp_mux:src_ready
	wire   [1:0] rsp_mux_src_channel;                                                            // rsp_mux:src_channel -> cpu_inst_data_master_agent:rp_channel
	...
	wire  [91:0] rsp_mux_001_src_data;                                                           // rsp_mux_001:src_data -> cpu_inst_instruction_master_agent:rp_data
	wire         rsp_mux_001_src_ready;                                                          // cpu_inst_instruction_master_agent:rp_ready -> rsp_mux_001:src_ready
	wire   [1:0] rsp_mux_001_src_channel;                                                        // rsp_mux_001:src_channel -> cpu_inst_instruction_master_agent:rp_channel
	...
	wire  [92:0] sequencer_mem_s1_agent_rf_source_data;                                          // sequencer_mem_s1_agent:rf_source_data -> sequencer_mem_s1_agent_rsp_fifo:in_data
	...
	wire  [92:0] sequencer_mem_s1_agent_rsp_fifo_out_data;                                       // sequencer_mem_s1_agent_rsp_fifo:out_data -> sequencer_mem_s1_agent:rf_sink_data
	...
	wire         cmd_mux_src_valid;                                                              // cmd_mux:src_valid -> sequencer_mem_s1_agent:cp_valid
	wire  [91:0] cmd_mux_src_data;                                                               // cmd_mux:src_data -> sequencer_mem_s1_agent:cp_data
	wire         cmd_mux_src_ready;                                                              // sequencer_mem_s1_agent:cp_ready -> cmd_mux:src_ready
	wire   [1:0] cmd_mux_src_channel;                                                            // cmd_mux:src_channel -> sequencer_mem_s1_agent:cp_channel
	wire         cmd_mux_src_startofpacket;                                                      // cmd_mux:src_startofpacket -> sequencer_mem_s1_agent:cp_startofpacket
	wire         cmd_mux_src_endofpacket;                                                        // cmd_mux:src_endofpacket -> sequencer_mem_s1_agent:cp_endofpacket
	wire  [31:0] avl2apb_avalon_slave_agent_m0_readdata;                                         // avl2apb_avalon_slave_translator:uav_readdata -> avl2apb_avalon_slave_agent:m0_readdata
	wire         avl2apb_avalon_slave_agent_m0_waitrequest;                                      // avl2apb_avalon_slave_translator:uav_waitrequest -> avl2apb_avalon_slave_agent:m0_waitrequest
	wire         avl2apb_avalon_slave_agent_m0_debugaccess;                                      // avl2apb_avalon_slave_agent:m0_debugaccess -> avl2apb_avalon_slave_translator:uav_debugaccess
	wire  [19:0] avl2apb_avalon_slave_agent_m0_address;                                          // avl2apb_avalon_slave_agent:m0_address -> avl2apb_avalon_slave_translator:uav_address
	wire   [3:0] avl2apb_avalon_slave_agent_m0_byteenable;                                       // avl2apb_avalon_slave_agent:m0_byteenable -> avl2apb_avalon_slave_translator:uav_byteenable
	wire         avl2apb_avalon_slave_agent_m0_read;                                             // avl2apb_avalon_slave_agent:m0_read -> avl2apb_avalon_slave_translator:uav_read
	wire         avl2apb_avalon_slave_agent_m0_readdatavalid;                                    // avl2apb_avalon_slave_translator:uav_readdatavalid -> avl2apb_avalon_slave_agent:m0_readdatavalid
	wire         avl2apb_avalon_slave_agent_m0_lock;                                             // avl2apb_avalon_slave_agent:m0_lock -> avl2apb_avalon_slave_translator:uav_lock
	wire  [31:0] avl2apb_avalon_slave_agent_m0_writedata;                                        // avl2apb_avalon_slave_agent:m0_writedata -> avl2apb_avalon_slave_translator:uav_writedata
	wire         avl2apb_avalon_slave_agent_m0_write;                                            // avl2apb_avalon_slave_agent:m0_write -> avl2apb_avalon_slave_translator:uav_write
	wire   [2:0] avl2apb_avalon_slave_agent_m0_burstcount;                                       // avl2apb_avalon_slave_agent:m0_burstcount -> avl2apb_avalon_slave_translator:uav_burstcount
	wire         avl2apb_avalon_slave_agent_rf_source_valid;                                     // avl2apb_avalon_slave_agent:rf_source_valid -> avl2apb_avalon_slave_agent_rsp_fifo:in_valid
	wire  [92:0] avl2apb_avalon_slave_agent_rf_source_data;                                      // avl2apb_avalon_slave_agent:rf_source_data -> avl2apb_avalon_slave_agent_rsp_fifo:in_data
	wire         avl2apb_avalon_slave_agent_rf_source_ready;                                     // avl2apb_avalon_slave_agent_rsp_fifo:in_ready -> avl2apb_avalon_slave_agent:rf_source_ready
	wire         avl2apb_avalon_slave_agent_rf_source_startofpacket;                             // avl2apb_avalon_slave_agent:rf_source_startofpacket -> avl2apb_avalon_slave_agent_rsp_fifo:in_startofpacket
	wire         avl2apb_avalon_slave_agent_rf_source_endofpacket;                               // avl2apb_avalon_slave_agent:rf_source_endofpacket -> avl2apb_avalon_slave_agent_rsp_fifo:in_endofpacket
	wire         avl2apb_avalon_slave_agent_rsp_fifo_out_valid;                                  // avl2apb_avalon_slave_agent_rsp_fifo:out_valid -> avl2apb_avalon_slave_agent:rf_sink_valid
	wire  [92:0] avl2apb_avalon_slave_agent_rsp_fifo_out_data;                                   // avl2apb_avalon_slave_agent_rsp_fifo:out_data -> avl2apb_avalon_slave_agent:rf_sink_data
	wire         avl2apb_avalon_slave_agent_rsp_fifo_out_ready;                                  // avl2apb_avalon_slave_agent:rf_sink_ready -> avl2apb_avalon_slave_agent_rsp_fifo:out_ready
	wire         avl2apb_avalon_slave_agent_rsp_fifo_out_startofpacket;                          // avl2apb_avalon_slave_agent_rsp_fifo:out_startofpacket -> avl2apb_avalon_slave_agent:rf_sink_startofpacket
	wire         avl2apb_avalon_slave_agent_rsp_fifo_out_endofpacket;                            // avl2apb_avalon_slave_agent_rsp_fifo:out_endofpacket -> avl2apb_avalon_slave_agent:rf_sink_endofpacket
	wire         cpu_inst_data_master_agent_cp_valid;                                            // cpu_inst_data_master_agent:cp_valid -> router:sink_valid
	wire  [91:0] cpu_inst_data_master_agent_cp_data;                                             // cpu_inst_data_master_agent:cp_data -> router:sink_data
	...
	wire  [91:0] cpu_inst_instruction_master_agent_cp_data;                                      // cpu_inst_instruction_master_agent:cp_data -> router_001:sink_data
	...
	wire         sequencer_mem_s1_agent_rp_valid;                                                // sequencer_mem_s1_agent:rp_valid -> router_002:sink_valid
	wire  [91:0] sequencer_mem_s1_agent_rp_data;                                                 // sequencer_mem_s1_agent:rp_data -> router_002:sink_data
	wire         sequencer_mem_s1_agent_rp_ready;                                                // router_002:sink_ready -> sequencer_mem_s1_agent:rp_ready
	wire         sequencer_mem_s1_agent_rp_startofpacket;                                        // sequencer_mem_s1_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire         sequencer_mem_s1_agent_rp_endofpacket;                                          // sequencer_mem_s1_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire         avl2apb_avalon_slave_agent_rp_valid;                                            // avl2apb_avalon_slave_agent:rp_valid -> router_003:sink_valid
	wire  [91:0] avl2apb_avalon_slave_agent_rp_data;                                             // avl2apb_avalon_slave_agent:rp_data -> router_003:sink_data
	wire         avl2apb_avalon_slave_agent_rp_ready;                                            // router_003:sink_ready -> avl2apb_avalon_slave_agent:rp_ready
	wire         avl2apb_avalon_slave_agent_rp_startofpacket;                                    // avl2apb_avalon_slave_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire         avl2apb_avalon_slave_agent_rp_endofpacket;                                      // avl2apb_avalon_slave_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire         cmd_mux_001_src_valid;                                                          // cmd_mux_001:src_valid -> avl2apb_avalon_slave_burst_adapter:sink0_valid
	wire  [91:0] cmd_mux_001_src_data;                                                           // cmd_mux_001:src_data -> avl2apb_avalon_slave_burst_adapter:sink0_data
	wire         cmd_mux_001_src_ready;                                                          // avl2apb_avalon_slave_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire   [1:0] cmd_mux_001_src_channel;                                                        // cmd_mux_001:src_channel -> avl2apb_avalon_slave_burst_adapter:sink0_channel
	wire         cmd_mux_001_src_startofpacket;                                                  // cmd_mux_001:src_startofpacket -> avl2apb_avalon_slave_burst_adapter:sink0_startofpacket
	wire         cmd_mux_001_src_endofpacket;                                                    // cmd_mux_001:src_endofpacket -> avl2apb_avalon_slave_burst_adapter:sink0_endofpacket
	wire         avl2apb_avalon_slave_burst_adapter_source0_valid;                               // avl2apb_avalon_slave_burst_adapter:source0_valid -> avl2apb_avalon_slave_agent:cp_valid
	wire  [91:0] avl2apb_avalon_slave_burst_adapter_source0_data;                                // avl2apb_avalon_slave_burst_adapter:source0_data -> avl2apb_avalon_slave_agent:cp_data
	wire         avl2apb_avalon_slave_burst_adapter_source0_ready;                               // avl2apb_avalon_slave_agent:cp_ready -> avl2apb_avalon_slave_burst_adapter:source0_ready
	wire   [1:0] avl2apb_avalon_slave_burst_adapter_source0_channel;                             // avl2apb_avalon_slave_burst_adapter:source0_channel -> avl2apb_avalon_slave_agent:cp_channel
	wire         avl2apb_avalon_slave_burst_adapter_source0_startofpacket;                       // avl2apb_avalon_slave_burst_adapter:source0_startofpacket -> avl2apb_avalon_slave_agent:cp_startofpacket
	wire         avl2apb_avalon_slave_burst_adapter_source0_endofpacket;                         // avl2apb_avalon_slave_burst_adapter:source0_endofpacket -> avl2apb_avalon_slave_agent:cp_endofpacket
	...
	wire         sequencer_mem_s1_agent_rdata_fifo_src_valid;                                    // sequencer_mem_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter:in_0_valid
	wire  [33:0] sequencer_mem_s1_agent_rdata_fifo_src_data;                                     // sequencer_mem_s1_agent:rdata_fifo_src_data -> avalon_st_adapter:in_0_data
	wire         sequencer_mem_s1_agent_rdata_fifo_src_ready;                                    // avalon_st_adapter:in_0_ready -> sequencer_mem_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_out_0_valid;                                                  // avalon_st_adapter:out_0_valid -> sequencer_mem_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_out_0_data;                                                   // avalon_st_adapter:out_0_data -> sequencer_mem_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_out_0_ready;                                                  // sequencer_mem_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire   [0:0] avalon_st_adapter_out_0_error;                                                  // avalon_st_adapter:out_0_error -> sequencer_mem_s1_agent:rdata_fifo_sink_error
	wire         avl2apb_avalon_slave_agent_rdata_fifo_src_valid;                                // avl2apb_avalon_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire  [33:0] avl2apb_avalon_slave_agent_rdata_fifo_src_data;                                 // avl2apb_avalon_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire         avl2apb_avalon_slave_agent_rdata_fifo_src_ready;                                // avalon_st_adapter_001:in_0_ready -> avl2apb_avalon_slave_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_001_out_0_valid;                                              // avalon_st_adapter_001:out_0_valid -> avl2apb_avalon_slave_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_001_out_0_data;                                               // avalon_st_adapter_001:out_0_data -> avl2apb_avalon_slave_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_001_out_0_ready;                                              // avl2apb_avalon_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire   [0:0] avalon_st_adapter_001_out_0_error;                                              // avalon_st_adapter_001:out_0_error -> avl2apb_avalon_slave_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) avl2apb_avalon_slave_translator (
		.clk                    (p0_avl_clk_clk),                               //                      clk.clk
		.reset                  (cpu_inst_reset_n_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (avl2apb_avalon_slave_agent_m0_address),        // avalon_universal_slave_0.address
		.uav_burstcount         (avl2apb_avalon_slave_agent_m0_burstcount),     //                         .burstcount
		.uav_read               (avl2apb_avalon_slave_agent_m0_read),           //                         .read
		.uav_write              (avl2apb_avalon_slave_agent_m0_write),          //                         .write
		.uav_waitrequest        (avl2apb_avalon_slave_agent_m0_waitrequest),    //                         .waitrequest
		.uav_readdatavalid      (avl2apb_avalon_slave_agent_m0_readdatavalid),  //                         .readdatavalid
		.uav_byteenable         (avl2apb_avalon_slave_agent_m0_byteenable),     //                         .byteenable
		.uav_readdata           (avl2apb_avalon_slave_agent_m0_readdata),       //                         .readdata
		.uav_writedata          (avl2apb_avalon_slave_agent_m0_writedata),      //                         .writedata
		.uav_lock               (avl2apb_avalon_slave_agent_m0_lock),           //                         .lock
		.uav_debugaccess        (avl2apb_avalon_slave_agent_m0_debugaccess),    //                         .debugaccess
		.av_address             (avl2apb_avalon_slave_address),                 //      avalon_anti_slave_0.address
		.av_write               (avl2apb_avalon_slave_write),                   //                         .write
		.av_read                (avl2apb_avalon_slave_read),                    //                         .read
		.av_readdata            (avl2apb_avalon_slave_readdata),                //                         .readdata
		.av_writedata           (avl2apb_avalon_slave_writedata),               //                         .writedata
		.av_byteenable          (avl2apb_avalon_slave_byteenable),              //                         .byteenable
		.av_waitrequest         (avl2apb_avalon_slave_waitrequest),             //                         .waitrequest
		.av_begintransfer       (),                                             //              (terminated)
		.av_beginbursttransfer  (),                                             //              (terminated)
		.av_burstcount          (),                                             //              (terminated)
		.av_readdatavalid       (1'b0),                                         //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) avl2apb_avalon_slave_agent (
		.clk                     (p0_avl_clk_clk),                                           //             clk.clk
		.reset                   (cpu_inst_reset_n_reset_bridge_in_reset_reset),             //       clk_reset.reset
		.m0_address              (avl2apb_avalon_slave_agent_m0_address),                    //              m0.address
		.m0_burstcount           (avl2apb_avalon_slave_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (avl2apb_avalon_slave_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (avl2apb_avalon_slave_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (avl2apb_avalon_slave_agent_m0_lock),                       //                .lock
		.m0_readdata             (avl2apb_avalon_slave_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (avl2apb_avalon_slave_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (avl2apb_avalon_slave_agent_m0_read),                       //                .read
		.m0_waitrequest          (avl2apb_avalon_slave_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (avl2apb_avalon_slave_agent_m0_writedata),                  //                .writedata
		.m0_write                (avl2apb_avalon_slave_agent_m0_write),                      //                .write
		.rp_endofpacket          (avl2apb_avalon_slave_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (avl2apb_avalon_slave_agent_rp_ready),                      //                .ready
		.rp_valid                (avl2apb_avalon_slave_agent_rp_valid),                      //                .valid
		.rp_data                 (avl2apb_avalon_slave_agent_rp_data),                       //                .data
		.rp_startofpacket        (avl2apb_avalon_slave_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (avl2apb_avalon_slave_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (avl2apb_avalon_slave_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (avl2apb_avalon_slave_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (avl2apb_avalon_slave_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (avl2apb_avalon_slave_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (avl2apb_avalon_slave_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (avl2apb_avalon_slave_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (avl2apb_avalon_slave_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (avl2apb_avalon_slave_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (avl2apb_avalon_slave_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (avl2apb_avalon_slave_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (avl2apb_avalon_slave_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (avl2apb_avalon_slave_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (avl2apb_avalon_slave_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (avl2apb_avalon_slave_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (avl2apb_avalon_slave_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_001_out_0_ready),                        // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_001_out_0_valid),                        //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_001_out_0_data),                         //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_001_out_0_error),                        //                .error
		.rdata_fifo_src_ready    (avl2apb_avalon_slave_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (avl2apb_avalon_slave_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (avl2apb_avalon_slave_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                                    //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                      //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) avl2apb_avalon_slave_agent_rsp_fifo (
		.clk               (p0_avl_clk_clk),                                        //       clk.clk
		.reset             (cpu_inst_reset_n_reset_bridge_in_reset_reset),          // clk_reset.reset
		.in_data           (avl2apb_avalon_slave_agent_rf_source_data),             //        in.data
		.in_valid          (avl2apb_avalon_slave_agent_rf_source_valid),            //          .valid
		.in_ready          (avl2apb_avalon_slave_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (avl2apb_avalon_slave_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (avl2apb_avalon_slave_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (avl2apb_avalon_slave_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (avl2apb_avalon_slave_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (avl2apb_avalon_slave_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (avl2apb_avalon_slave_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (avl2apb_avalon_slave_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                                 // (terminated)
		.csr_read          (1'b0),                                                  // (terminated)
		.csr_write         (1'b0),                                                  // (terminated)
		.csr_readdata      (),                                                      // (terminated)
	...
	hps_sdram_mm_interconnect_1_router router (
	...
	hps_sdram_mm_interconnect_1_router_001 router_001 (
	...
	hps_sdram_mm_interconnect_1_router_002 router_002 (
	...
	hps_sdram_mm_interconnect_1_router_003 router_003 (
		.sink_ready         (avl2apb_avalon_slave_agent_rp_ready),          //      sink.ready
		.sink_valid         (avl2apb_avalon_slave_agent_rp_valid),          //          .valid
		.sink_data          (avl2apb_avalon_slave_agent_rp_data),           //          .data
		.sink_startofpacket (avl2apb_avalon_slave_agent_rp_startofpacket),  //          .startofpacket
		.sink_endofpacket   (avl2apb_avalon_slave_agent_rp_endofpacket),    //          .endofpacket
		.clk                (p0_avl_clk_clk),                               //       clk.clk
		.reset              (cpu_inst_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_burst_adapter #(
	...
	) avl2apb_avalon_slave_burst_adapter (
		.clk                   (p0_avl_clk_clk),                                           //       cr0.clk
		.reset                 (cpu_inst_reset_n_reset_bridge_in_reset_reset),             // cr0_reset.reset
		...
		.source0_valid         (avl2apb_avalon_slave_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (avl2apb_avalon_slave_burst_adapter_source0_data),          //          .data
		.source0_channel       (avl2apb_avalon_slave_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (avl2apb_avalon_slave_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (avl2apb_avalon_slave_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (avl2apb_avalon_slave_burst_adapter_source0_ready)          //          .ready
	);

	hps_sdram_mm_interconnect_1_cmd_demux cmd_demux (
		.clk                (p0_avl_clk_clk),                               //       clk.clk
		.reset              (cpu_inst_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hps_sdram_mm_interconnect_1_cmd_demux_001 cmd_demux_001 (
		.clk                (p0_avl_clk_clk),                               //       clk.clk
		.reset              (cpu_inst_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hps_sdram_mm_interconnect_1_cmd_mux cmd_mux (
		.clk                 (p0_avl_clk_clk),                               //       clk.clk
		.reset               (cpu_inst_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hps_sdram_mm_interconnect_1_cmd_mux_001 cmd_mux_001 (
		.clk                 (p0_avl_clk_clk),                               //       clk.clk
		.reset               (cpu_inst_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hps_sdram_mm_interconnect_1_cmd_demux rsp_demux (
		.clk                (p0_avl_clk_clk),                               //       clk.clk
		.reset              (cpu_inst_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hps_sdram_mm_interconnect_1_cmd_demux_001 rsp_demux_001 (
		.clk                (p0_avl_clk_clk),                               //       clk.clk
		.reset              (cpu_inst_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hps_sdram_mm_interconnect_1_rsp_mux rsp_mux (
		.clk                 (p0_avl_clk_clk),                               //       clk.clk
		.reset               (cpu_inst_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hps_sdram_mm_interconnect_1_rsp_mux_001 rsp_mux_001 (
		.clk                 (p0_avl_clk_clk),                               //       clk.clk
		.reset               (cpu_inst_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hps_sdram_mm_interconnect_1_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
	...
	hps_sdram_mm_interconnect_1_avalon_st_adapter #(
		...
		.in_clk_0_clk   (p0_avl_clk_clk),                                  // in_clk_0.clk
		.in_rst_0_reset (cpu_inst_reset_n_reset_bridge_in_reset_reset),    // in_rst_0.reset
		.in_0_data      (avl2apb_avalon_slave_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (avl2apb_avalon_slave_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (avl2apb_avalon_slave_agent_rdata_fifo_src_ready), //         .ready
